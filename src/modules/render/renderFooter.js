   ...
   footer.innerHTML = `
      <div class="container">
         <div class="footer__container">
            ...
            </div><!-- /.footer__item footer-category -->
   
            <div class="footer__item footer__item_social footer-social">
               <h3 class="footer__title footer-social__title">Связаться с нами</h3>
            ...
            </div><!-- /.footer__item footer-social -->
            ...
            </div><!-- /.footer__item footer-contacts -->
   
            <div class="footer__item footer__item_copyright footer-copyright">
               <p>© INSPIRED, 2023</p>
            </div><!-- /.footer__item footer-copyright -->
            ...
            <div class="footer__item footer__item_development footer-development">
               <ul class="footer-development__list">
                  <li class="footer-development__item">
                     Designer: <a class="footer__link" href="https://t.me/Mrshmalloww">Anastasia Ilina</a>
                  </li>
   
                  <li class="footer-development__item">
                     Developer: <a class="footer__link" href="https://t.me/keepgen">KeepGen</a>
                  </li>
               </ul>
            </div><!-- /.footer__item footer-development -->
